<aside
    ...
    <div class="sidenav-header">
        <i class="fas fa-times p-3 cursor-pointer text-white opacity-5 position-absolute end-0 top-0 d-none d-xl-none"
            ...
            <a class="navbar-brand m-0 d-flex text-wrap align-items-center" href=" {{ route('dashboard') }} ">
                ...
                <span class="ms-2 font-weight-bold text-white">CVshare1</span>
            </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item mt-3">
                <h6 class="ps-4 ms-2 text-uppercase text-xs text-white font-weight-bolder opacity-8">Menu1</h6>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ Route::currentRouteName() == 'containers' ? ' active bg-gradient-primary' : '' }} "
                    href="{{ route('container') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">table_view</i>
                    </div>
                    <span class="nav-link-text ms-1">Container</span>
                </a>
            </li>
            <li class="nav-item">
    ...
    <!--
        <div class="mx-3">
            <a class="btn bg-gradient-primary w-100" href="https://www.creative-tim.com/product/material-dashboard-laravel-livewire" target="_blank">Fre1e Download</a>
        </div>
        <div class="mx-3">
